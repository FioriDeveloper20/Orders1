						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#CustomerOrders-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"CustomerOrders-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=learninghub.learningroom.orders2",
									"url": sap.ui.require.toUrl("learninghub/learningroom/orders2")
								}
							}
						}
					}

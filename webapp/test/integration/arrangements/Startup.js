sap.ui.define([
	"sap/ui/test/Opa5",
	"learninghub/learningroom/orders2/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("learninghub.learningroom.orders2.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "learninghub.learningroom.orders2",
					async: true
				},
				hash: oOptions.hash,
